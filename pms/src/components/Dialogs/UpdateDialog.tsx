...
export default function UpdateDialog(props: IClient) {
  const [id, setId] = React.useState(props.id)
  const [nameValue, setNameValue] = React.useState<string>(props.name);
  const [error, setError] = React.useState<Boolean>(false);
  const [success, setSuccess] = React.useState<Boolean>(false);
  const [validate, setValidate] = React.useState<Boolean>(false);
  const [errorMessage, setErrorMessage] = React.useState<string>("");
  const [successMessage, setSuccessMessage] = React.useState<string>("");
  const [cpfValue, setCPFValue] = React.useState<string>(props.cpf);
  const [value, setValue] = React.useState<Date | null>(props.birthDate);
